...
DATABASES = {
    'default': {
        ...
        'NAME': secret_manager('LOCAL_DATABASE_NAME'),
        'USER': 'postgres',
        'PASSWORD': secret_manager('LOCAL_DATABASE_PASSWORD'),
        'HOST': '127.0.0.1',
        'PORT': '5432',
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ecom.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Ramsharan Kanwar""", "ramsharankanwar@protonmail.com")]
...
ACCOUNT_FORMS = {"signup": "ecom.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "ecom.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "ecom.users.forms.UserSocialSignupForm"}
